        ...
        <!-- Small boxes (Stat box) -->
               ...
               <div class="card-header">
                <h3>Add slider </h3>
                	...
                	<a class="btn btn-primary float-right" href="{{route('slider.view')}}"><i class="fa fa-user-circle"></i>  view slider</a>
              ...
              <div class="card-body">
                  ...
                  <form method="POST" action="{{route('slider.store','id')}}" id="myform" enctype="multipart/form-data">
                        ...
                        @csrf
                         <div class="form-group col-md-6">
                          ...
                          <div class="form-group col-md-6">
	                        		...
	                        		<input id="long_title" type="text" name="long_title" class="form-control ">
